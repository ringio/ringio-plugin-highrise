module ApiOperations
  ...
  module Notes
    ...
    def self.synchronize_contact(contact_map)
      ...
      hr_notes = contact_map.hr_notes_feed.reject{|n| n.author_id != contact_map.user_map.rg_user_id}

      # give priority to Highrise: apply changes first to Ringio
      self.apply_changes_rg_to_hr(contact_map,rg_updated_notes_ids,rg_deleted_notes_ids)
      self.apply_changes_hr_to_rg(contact_map,hr_notes)
    ...
    private
      ...
      def self.apply_changes_hr_to_rg(contact_map,hr_notes)
        ...
        contact_map.note_maps.each do |nm|
          ...
          if rg_note.author_id == contact_map.user_map.rg_user_id
      ...
      def self.hr_note_to_rg_note(contact_map,hr_note,rg_note)
        ...
        # strip html tags from the body of the note and restrict the length to the first 50 chars 
        rg_note.body = (hr_note.body.gsub(/<\/?[^>]*>/, ''))[0,49]
      end


      def self.apply_changes_rg_to_hr(contact_map,rg_updated_notes_ids,rg_deleted_notes_ids)
